...
import br.com.senaijandira.mybooks.adapters.LivroParaLerAdapter;
import br.com.senaijandira.mybooks.MyBooksDatabase;
import br.com.senaijandira.mybooks.R;
import br.com.senaijandira.mybooks.Utils;
import br.com.senaijandira.mybooks.model.Livro;

public class LivrosParaLer extends Fragment {
    ...
    LivroParaLerAdapter adapter;


    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_livrosparaler,container, false);
        ...
        /*CRIAR ADAPTER*/
        adapter = new LivroParaLerAdapter(getContext(),myBooksDB );
    ...
    public void onResume() {
        ...
        Livro[] resultadoQueroLer = myBooksDB.daoLivro().selecionarLivrosQueroLer();
        adapter.addAll(resultadoQueroLer);
